...
filepath_list = []
for i in range(1, 13):
    filepath_list.append('/home/cseadmin/mhy/data-NYCBike/{}min/2019{}-citibike-tripdata-graph-inoutflow.npz'.format(TIME_STEP, str(i).zfill(2)))
for i in range(1, 13):
    filepath_list.append('/home/cseadmin/mhy/data-NYCBike/{}min/2020{}-citibike-tripdata-graph-inoutflow.npz'.format(TIME_STEP, str(i).zfill(2)))
