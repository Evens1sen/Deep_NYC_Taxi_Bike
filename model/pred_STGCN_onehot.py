...
parser.add_argument("--flowpath", type=str, default='../data-NYCTaxi/60min/2019-2020-bike-taxi-inoutflow.npz',
                    help="the absolute path of flow file")
parser.add_argument("--adjpath", type=str, default='../data-NYCZones/adjmatrix/W_adj_matrix.csv',
                    help="the absolute path of adj file")
...
parser.add_argument('--target', type=int, default=0,
                    help='predict target 0:bike inflow 1: bike outflow 2:taxi inflow 3:taxi outflow')
...
if ADDTIME:
    ...
    print('timestamp shape is', timestamp.shape)
    data = data.values
else:
